...
export function Collapse({ title, description, icon, defaultOpen = true, children, className = '' }: CollapseProps) {
  const [open, setOpen] = React.useState(defaultOpen)

  return (
    <CollapsiblePrimitive.Root open={open} onOpenChange={setOpen} className={`collapse-root ${className}`}>
